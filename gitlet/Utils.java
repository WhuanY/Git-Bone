...
class Utils {
    ...
    /**
     * simplify failure cases operation
     */
    static void exitWithErrorMsg(String msg) {
        message(msg);
        System.exit(0);
    }
    ...
    static String humanReadableTime(long unixTime) {
        Instant instant = Instant.ofEpochMilli(unixTime);
        ZoneId zoneId = ZoneId.of("-08:00"); // Adjust as needed
